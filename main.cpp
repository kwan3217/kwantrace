...
int main() {
  kwantrace::exercise_pointToward();
  ...
  */
  auto plane=scene.addObject(std::make_shared<Plane>());
  ...
  scene.addObject(groupX);
  auto sphereX1=groupX->addObject(std::make_shared<kwantrace::Sphere>());
  sphereX1->scale(0.5);
  sphereX1->translate(0,0.5,0);
  auto sphereX2=groupX->addObject(std::make_shared<kwantrace::Sphere>());
  sphereX2->scale(0.25);
  sphereX2->translate(0,-0.25,0);
  auto sphereX3=groupX->addObject(std::make_shared<kwantrace::Sphere>());
  sphereX3->scale(0.25);
  ...
  scene.addObject(groupY);
  auto sphereY1=groupY->addObject(std::make_shared<kwantrace::Sphere>());
  sphereY1->scale(0.5);
  sphereY1->translate(0,0.5,0);
  auto sphereY2=groupY->addObject(std::make_shared<kwantrace::Sphere>());
  sphereY2->scale(0.25);
  sphereY2->translate(0,-0.25,0);
  auto sphereY3=groupY->addObject(std::make_shared<kwantrace::Sphere>());
  sphereY3->scale(0.25);
  ...
  scene.addObject(groupZ);
  auto sphereZ1=groupZ->addObject(std::make_shared<kwantrace::Sphere>());
  sphereZ1->scale(0.5);
  sphereZ1->translate(0,0.5,0);
  auto sphereZ2=groupZ->addObject(std::make_shared<kwantrace::Sphere>());
  sphereZ2->scale(0.25);
  sphereZ2->translate(0,-0.25,0);
  auto sphereZ3=groupZ->addObject(std::make_shared<kwantrace::Sphere>());
  sphereZ3->scale(0.25);
  ...
  for(int i=0;i<100;i++) {
    ...
    fclose(oufb);
    std::cout << "Finished frame "<<i<<" of "<<100 << std::endl;
  }
}